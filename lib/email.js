...
export const EMAIL_DEFAULTS = {
  ...
  ownerNewBooking: {
    ...
    body: `<strong>{{name}}</strong> just booked and paid a \${{deposit}} deposit.<br><br><strong>Service:</strong> {{service}}</strong><br><strong>Date:</strong> {{date}} at {{time}}<br><strong>Email:</strong> {{email}}<br><strong>Phone:</strong> {{phone}}<br><br>Log in to your dashboard to accept or decline it. The date is already held for you.`,
  },
  ownerCancelled: {
